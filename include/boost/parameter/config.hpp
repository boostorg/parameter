...
// a variadic implementation of boost::fusion::list/deque, needed by
...
// cannot disambiguate between keyword's overloaded operators.  Newer versions
// of MSVC fail on the evaluate_category and preprocessor_eval_category test
