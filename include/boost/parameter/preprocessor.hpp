...
// Given Match, which is "void x" where x is an argument matching criterion,
// extract a corresponding MPL predicate.
...
// A type to which the argument is supposed to be convertible is specified.
...
struct funptr_predicate
{
    ...
    static typename mpl::if_<
      ...
      , char
      , int
    >::type check_predicate(boost::type<T>, Args*, void*(*)(P0));
...
template <>
struct funptr_predicate<void**> : mpl::always<mpl::true_>
{
};
...
#define BOOST_PARAMETER_FN_ARG_KEYWORD(x) \
    BOOST_PARAMETER_FUNCTION_KEYWORD(BOOST_PARAMETER_FN_ARG_NAME(x))
/**/
...
// Produce a name for a result type metafunction for the function named base.
...
#if defined BOOST_PARAMETER_HAS_PERFECT_FORWARDING
#define BOOST_PARAMETER_FUNCTION_ARG_TYPE(r, _, i, seq) \
    BOOST_PP_COMMA_IF(i) \
    BOOST_PP_CAT(ParameterArgumentType, BOOST_PP_SEQ_ELEM(0, seq)) \
    BOOST_PP_IF(BOOST_PP_SEQ_ELEM(1, seq), &&, const&)
/**/
#define BOOST_PARAMETER_FUNCTION_FWD_PARAM_0(i, j) BOOST_PP_CAT(a, i)
#define BOOST_PARAMETER_FUNCTION_FWD_PARAM_1(i, j) \
    boost::forward<BOOST_PP_CAT(ParameterArgumentType, j)>( \
        BOOST_PP_CAT(a, i) \
    )
/**/
#define BOOST_PARAMETER_FUNCTION_FWD_PARAM(r, _, i, seq) \
    BOOST_PP_COMMA_IF(i) BOOST_PP_IF( \
        BOOST_PP_SEQ_ELEM(1, seq) \
      , BOOST_PARAMETER_FUNCTION_FWD_PARAM_1 \
      , BOOST_PARAMETER_FUNCTION_FWD_PARAM_0 \
    )(i, BOOST_PP_SEQ_ELEM(0, seq))
/**/
#else // !defined BOOST_PARAMETER_HAS_PERFECT_FORWARDING
#define BOOST_PARAMETER_FUNCTION_ARG_TYPE(r, _, i, elem) \
    BOOST_PP_COMMA_IF(i) elem&
/**/
#define BOOST_PARAMETER_FUNCTION_FWD_PARAM(r, _, i, elem) \
    BOOST_PP_COMMA_IF(i) BOOST_PP_CAT(a, i)
/**/
#endif

#define BOOST_PARAMETER_FUNCTION_ARGUMENT(r, _, i, seq) \
    BOOST_PARAMETER_FUNCTION_ARG_TYPE(r, _, i, seq) BOOST_PP_CAT(a, i)
/**/

#define BOOST_PARAMETER_FUNCTION_FWD_FUNCTION00(z, n, r, data, elem) \
    BOOST_PP_IF( \
        n \
      , BOOST_PARAMETER_FUNCTION_FWD_FUNCTION_TEMPLATE_Z \
    ...
    BOOST_PP_EXPR_IF(n, typename) \
        ...
        boost::parameter::aux::argument_pack< \
            BOOST_PARAMETER_FUNCTION_PARAMETERS_NAME( \
                BOOST_PP_TUPLE_ELEM(7, 3, data) \
            ) \
            BOOST_PP_COMMA_IF(n) \
            BOOST_PP_IF( \
              ...
              , BOOST_PP_TUPLE_EAT(4) \
                ...
                r \
              , BOOST_PARAMETER_FUNCTION_ARG_TYPE \
              , ~ \
              , elem \
            ) \
        >::type \
            ...
            BOOST_PARAMETER_FUNCTION_PARAMETERS_NAME( \
                ...
                BOOST_PP_IF( \
                  ...
                  , BOOST_PP_TUPLE_EAT(4) \
                    ...
                    r \
                  , BOOST_PARAMETER_FUNCTION_FWD_PARAM \
                  , ~ \
                  , elem \
                ) \
            ) \
...
#define BOOST_PARAMETER_FUNCTION_FWD_FUNCTIONS( \
    result, name, args, const_, combinations \
) \
...
#define BOOST_PARAMETER_FUNCTION_DEFAULT_FUNCTION_BODY( \
    name, n, split_args, tag_namespace \
) \
    { \
...
#define BOOST_PARAMETER_FUNCTION_DEFAULT_EVAL_DEFAULT_BODY( \
    name, n, split_args, tag_ns, const_ \
) \
    template < \
        class ResultType \
      , class Args \
    ...
    { \
        return BOOST_PARAMETER_FUNCTION_DEFAULT_NAME(name)( \
          ...
          , BOOST_PARAMETER_FUNCTION_DEFAULT_EVAL_ACTUAL_DEFAULT( \
                BOOST_PP_SEQ_ELEM( \
                    BOOST_PP_SUB( \
                        BOOST_PP_TUPLE_ELEM(4, 2, split_args) \
                      , BOOST_PP_INC(n) \
                    ) \
                  , BOOST_PP_TUPLE_ELEM(4, 3, split_args) \
                ) \
...
// BOOST_PARAMETER_FUNCTION_DEFAULT_FUNCTION below.
#define BOOST_PARAMETER_FUNCTION_DEFAULT_FUNCTION0(z, n, data) \
    ...
    ResultType BOOST_PARAMETER_FUNCTION_DEFAULT_NAME( \
...
#define BOOST_PARAMETER_FUNCTION_DEFAULT_FUNCTION(z, n, data) \
    ...
    BOOST_PP_IF( \
        BOOST_PP_EQUAL( \
            n \
          , BOOST_PP_TUPLE_ELEM(4, 2, BOOST_PP_TUPLE_ELEM(5, 1, data)) \
        ) \
...
// Generates the function template that receives a ArgumentPack,
// and then goes on to call the layers of overloads generated by 
// BOOST_PARAMETER_FUNCTION_DEFAULT_LAYER.
#define BOOST_PARAMETER_FUNCTION_INITIAL_DISPATCH_FUNCTION( \
    name, split_args, const_, tag_ns \
) \
    template <class Args> \
...
// one more argument.
#define BOOST_PARAMETER_FUNCTION_DEFAULT_LAYER( \
    name, args, skip_fwd_decl, const_, tag_ns \
) \
...
/**/
#endif // Perfect forwarding support, or function template ordering disabled.
...
#define BOOST_PARAMETER_BASIC_FUNCTION_AUX( \
    result, name, tag_namespace, args \
) \
    BOOST_PARAMETER_FUNCTION_HEAD(result, name, tag_namespace, args)         \
...
#define BOOST_PARAMETER_BASIC_MEMBER_FUNCTION_AUX(                           \
    result, name, tag_namespace, args, const_                                \
)                                                                            \
    BOOST_PARAMETER_FUNCTION_HEAD(result, name, tag_namespace, args)         \
    BOOST_PARAMETER_FUNCTION_FWD_FUNCTIONS(                                  \
...
#define BOOST_PARAMETER_BASIC_MEMBER_FUNCTION( \
    result, name, tag_namespace, args \
) \
...
#define BOOST_PARAMETER_MEMBER_FUNCTION_AUX(                                 \
    result, name, tag_namespace, const_, args                                \
)                                                                            \
    BOOST_PARAMETER_FUNCTION_HEAD(result, name, tag_namespace, args)         \
    BOOST_PARAMETER_FUNCTION_FWD_FUNCTIONS(                                  \
        result, name, args, const_                                           \
    ...
    BOOST_PARAMETER_FUNCTION_DEFAULT_LAYER(                                  \
        name, args, 1, const_, tag_namespace                                 \
    )
/**/
...
#define BOOST_PARAMETER_CONST_MEMBER_FUNCTION(                               \
    result, name, tag_namespace, args                                        \
)                                                                            \
    BOOST_PARAMETER_MEMBER_FUNCTION_AUX(                                     \
...
#define BOOST_PARAMETER_FUNCTION_FWD_CONSTRUCTORS0( \
...
#define BOOST_PARAMETER_FUNCTION_FWD_CONSTRUCTORS( \
    class_, base, args, combinations \
) \
